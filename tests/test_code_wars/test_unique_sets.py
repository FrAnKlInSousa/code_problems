...
from src.code_problems.code_wars.kyu_6.unique_sets import unique_sets, unique_sets_gpt, unique_sets_gpt_improvement, \
    unique_sets_gpt_performance
...
@pytest.mark.parametrize('function', [unique_sets, unique_sets_gpt, unique_sets_gpt_improvement, unique_sets_gpt_performance])
